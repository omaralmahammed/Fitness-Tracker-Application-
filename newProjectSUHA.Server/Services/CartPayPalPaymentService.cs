...
{
    public class CartPayPalPaymentService
    {
        private readonly string clientId;
        private readonly string clientSecret;


        public CartPayPalPaymentService(IConfiguration config)
        {
                ...
                transactions = new List<Transaction>
        {
            new Transaction
            {
                ...
                redirect_urls = new RedirectUrls
                {
                    ...
                    return_url = $"{redirectUrl}/success?userId={userId}&totalPrice={total}"
                }
        ...
        public Payment ExecutePayment(string paymentId, string payerId, int userId,decimal totalPrice)
        {
